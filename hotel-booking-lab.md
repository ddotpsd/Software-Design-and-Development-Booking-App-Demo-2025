# ใบงานปฏิบัติการ: การพัฒนาระบบจองห้องพักออนไลน์แบบครบวงจร
...
1. เรียนรู้การพัฒนา Full-Stack Web Application แบบครบวงจร
2. เรียนรู้การสร้าง REST API ด้วย Node.js และ Express
3. เรียนรู้การพัฒนา Frontend ด้วย React และ Tailwind CSS
4. เรียนรู้การออกแบบและจัดการฐานข้อมูลด้วย SQLite
5. เรียนรู้การพัฒนาระบบ Authentication ด้วย JWT (JSON Web Token)
6. เรียนรู้การแบ่งสิทธิ์การเข้าใช้งานระหว่างผู้ใช้ทั่วไปและผู้ดูแลระบบ
